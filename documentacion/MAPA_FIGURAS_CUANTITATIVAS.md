...
Todas las figuras se construyen con `experimentos/comparacion/generar_figuras_v7.py`. La revisión final se realiza sobre los PDF integrados en la memoria y sobre sus PNG de control.
