...
\begin{description}
    ...
    \item[\textbf{RNF2. Reproducibilidad.}] Las particiones de datos, semillas, configuraciones, versiones de dependencias y checksums de los modelos deben quedar documentados.
