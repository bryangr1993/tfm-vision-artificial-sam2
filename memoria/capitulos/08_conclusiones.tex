...
El cumplimiento no implica que se haya demostrado una reducción de reprocesos en producción. Esa consecuencia pertenece al impacto esperado y necesita cortes físicos, mediciones de borde y comparación con el proceso manual. La Tabla~\ref{tab:cumplimiento_objetivos} relaciona los objetivos específicos con la evidencia obtenida y mantiene separadas ambas afirmaciones.
