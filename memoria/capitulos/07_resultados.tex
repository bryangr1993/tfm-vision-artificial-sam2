...
A partir de este diagnóstico se mantuvieron las 19 variables: añadir coordenadas llevó el Jaccard de 0,9810 a 0,9800. El ensayo no permite atribuir la mejora a un tipo concreto de borde, sombra o desenfoque ni establecer un efecto general de las coordenadas.
...
Para SAM 2 se cronometró la ruta completa, desde el localizador hasta el postprocesamiento, incluido el codificador de imagen y no solo la decodificación de las cajas. Su media en CPU fue de $2{,}1736$ segundos. Esto lo sitúa unas 15,9 veces por encima de la línea clásica y 5,9 veces por debajo de Random Forest. En este último método, buena parte de los $12{,}7163$ segundos se consume al calcular 19 variables para más de seis millones de píxeles.
