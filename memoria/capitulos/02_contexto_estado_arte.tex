...
\figuraopcional{dificultades_visuales_toppers}{0.9\textwidth}{Dificultades visuales presentes en las capturas reales, entre ellas sombras parciales, presencia del cabezal, rotación del soporte y cambios de posición de la cámara.}{fig:dificultades_visuales}
...
Una máscara binaria todavía no constituye una trayectoria de máquina. El contorno contiene una gran cantidad de vértices y pequeñas irregularidades propias del raster. El algoritmo de Douglas-Peucker reduce puntos redundantes dentro de una tolerancia geométrica \cite{DouglasPeucker1973}. Esta simplificación permite obtener polilíneas más limpias sin alterar de forma apreciable la silueta.
